    ...
    <div class="form-section__content">
      <div class="contact-form">
        <img class="contact-form__background"
          src="https://connectx.com.vn/wp-content/themes/astra-child/assets/imgs/imgBgForm.jpg" :alt="$t('contact_form.alt.background')">

        <div class="contact-form__content">
          <h2 class="contact-form__title">
            <span class="contact-form__title--highlight">{{ $t('contact_form.title.part1') }}</span>
            {{ $t('contact_form.title.part2') }}
            <span class="contact-form__title--highlight">{{ $t('contact_form.title.part3') }}</span>
            {{ $t('contact_form.title.part4') }}
          </h2>
          ...
          <div class="wpcf7 js" id="wpcf7-f6-o1" lang="vi" dir="ltr">
            ...
            <form @submit.prevent="sendContactMail" @keydown="form.onKeydown($event)" method="post" class="wpcf7-form init contact-form__form"
              :aria-label="$t('contact_form.aria.form_label')" novalidate="novalidate" data-status="init">

              <div class="contact-form__group">
                <div class="contact-form__input-wrapper">
                  <Fa icon="user" class="contact-form__icon" fw />
                  <div class="contact-form__field-container">
                    ...
                    <label for="nameInput" class="contact-form__label">
                      {{ $t('contact_form.labels.name') }}<span class="contact-form__required">*</span>
                    </label>
                  </div>
                </div>

                <div class="contact-form__input-wrapper">
                  <Fa icon="envelope" class="contact-form__icon" fw />
                  <div class="contact-form__field-container">
                    ...
                    <label for="mailInput" class="contact-form__label">
                      {{ $t('contact_form.labels.email') }}<span class="contact-form__required">*</span>
                    </label>
                  </div>
                </div>

                <div class="contact-form__input-wrapper">
                  <Fa icon="phone" class="contact-form__icon" fw />
                  <div class="contact-form__field-container">
                    ...
                    <label for="phoneInput" class="contact-form__label">
                      {{ $t('contact_form.labels.phone') }}<span class="contact-form__required">*</span>
                    </label>
                  </div>
                </div>

                <div class="contact-form__input-wrapper">
                  <Fa icon="comment" class="contact-form__icon" fw />
                  <div class="contact-form__field-container">
                    ...
                    <label for="messageInput" class="contact-form__label">{{ $t('contact_form.labels.message') }}</label>
                  </div>
                </div>
              </div>

              <div class="contact-form__submit-wrapper">
                <input :disabled="form.busy" class="dimaso-btn dimaso-btn-primary contact-form__submit-button" type="submit" :value="$t('contact_form.submit_button')">
  ...
  methods: {
    async sendContactMail () {
      try {
        ...
        alert(this.$t('contact_form.alerts.success'));
        this.form.reset(); 
        ...
        alert(this.$t('contact_form.alerts.error'));
      }
    }
  },
...
.contact-form__icon {
  flex-shrink: 0;
  font-size: 1.2rem; /* Đặt kích thước cho icon */
  color: #a1a1aa;   /* Đặt màu mặc định cho icon */
  transition: color 0.2s ease; /* Thêm transition cho mượt */
}
